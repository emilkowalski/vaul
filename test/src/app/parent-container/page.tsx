...
function WithSnapPoints() {
  const snapPoints = ['142px', '250px', 1];
  ...
  return (
    <div className="flex flex-col items-center gap-10">
      <h1 className="text-3xl font-semibold">With Snap Points</h1>
      <div
        ref={setParent}
        data-vaul-container=""
        className="bg-zinc-200 w-[440px] h-[400px] rounded-lg relative flex justify-center items-center overflow-hidden"
      >
        ...
        <Drawer.Root container={parent} snapPoints={snapPoints} activeSnapPoint={snap} setActiveSnapPoint={setSnap}>
...
function WithInitialSnapPoints() {
  const snapPoints = ['142px', '250px', 1];
  ...
  return (
    <div className="flex flex-col items-center gap-10">
      <h1 className="text-3xl font-semibold">With Initial Snap Points</h1>
      <div
        ref={setParent}
        data-vaul-container=""
        className="bg-zinc-200 w-[440px] h-[400px] rounded-lg relative flex justify-center items-center overflow-hidden"
