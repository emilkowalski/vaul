...
export default function Page() {
  const [mainSnap, setMainSnap] = useState<number | string | null>(snapPoints[0]);
  const [nestedSnap, setNestedSnap] = useState<number | string | null>(snapPoints[0]);

  const activeSnapPointIndex = snapPoints.indexOf(mainSnap as string);
            ...
            <div className="p-4 bg-white rounded-t-[10px] flex-1">
              ...
              <div className="max-w-md mx-auto">
                ...
                <Drawer.NestedRoot
                  ...
                  modal={false}
                  onOpenChange={(o) => console.log('nested on open change', o)}
                >
                  <Drawer.Trigger
