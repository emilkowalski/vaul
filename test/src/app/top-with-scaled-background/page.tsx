    ...
    <div className="w-screen h-screen bg-white p-8 flex justify-center items-center" vaul-drawer-wrapper="">
      <Drawer.Root shouldScaleBackground direction='top'>
        ...
        <Drawer.Portal>
          ...
          <Drawer.Content
            data-testid="content"
            className="bg-zinc-100 flex flex-col-reverse rounded-b-[10px] h-[96%] mb-10 fixed top-0 left-0 right-0"
          >
            <div className="p-4 bg-white rounded-b-[10px] flex-1 flex flex-col justify-between">
              ...
              <div className="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-zinc-300 mt-8" />
            </div>
