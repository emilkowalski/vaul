...
export default function Page() {
  ...
  return (
    <div className="w-screen h-screen bg-white p-8 flex justify-center items-center">
      ...
      <Drawer.Root snapPoints={snapPoints} activeSnapPoint={snap} setActiveSnapPoint={setSnap} direction='top'>
        <Drawer.Trigger asChild>
          <button data-testid="trigger">Open Top Drawer</button>
        </Drawer.Trigger>
        <Drawer.Overlay className="fixed inset-0 bg-black/40" />
        <Drawer.Portal>
          <Drawer.Content
            data-testid="content"
            className="fixed flex flex-col bg-white border border-gray-200 border-b-none rounded-b-[10px] top-0 left-0 right-0 h-full max-h-[97%] mx-[-1px]"
          >
            <div
              className={clsx('flex flex-col-reverse max-w-md mx-auto w-full p-4 pt-5', {
            ...
            >
              <div className='mb-2'>
                ...
                <p className="text-sm mt-1 text-gray-600 mb-4">2 modules, 27 hours of video</p>
              ...
              <button className="bg-black text-gray-50 mb-8 rounded-md h-[48px] flex-shrink-0 font-medium">
                Buy for $199
              </button>
              <div className="mb-12">
