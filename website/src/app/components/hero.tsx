      ...
      <div className="max-w-2xl mx-auto text-center pt-64">
        ...
        <div className="flex gap-4 justify-center mt-6">
          <Drawer.Root shouldScaleBackground>
            ...
            <Drawer.Portal>
              <Drawer.Content className="bg-white flex flex-col fixed bottom-0 left-0 right-0 rounded-t-[10px]">
                <div className="max-w-md w-full mx-auto flex flex-col overflow-auto p-4 rounded-t-[10px]">
                  <div className="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-gray-300 mb-8" />
                  <div className="max-w-md mx-auto">
                    <Drawer.Title className="font-medium mb-4">Bla bla dobra es .</Drawer.Title>
                    <p className="text-gray-600 mb-2">
                      We'd love to hear your feedback so that we can continue to improve. Please, let us know what you
                      think about Mr. Cook.
                    </p>
                    <p className="text-gray-600 mb-2">
